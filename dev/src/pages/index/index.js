...
$(document).ready(() => {
  ...
  modal();
  form();
   header(); nav(); calc(); actions(); advantages(); reviews(); accordion(); branches(); conditions(); footer();
});
