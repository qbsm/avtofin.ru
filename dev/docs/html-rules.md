...
| -------------------- | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Страница**         | Контейнер страницы, общие обёртки страницы                                     | классы страницы, например `.index`                                                                                                                                       |
...
| **placeholder** | Плейсхолдер поля ввода                                                     | в JSON: `placeholder.phone`                                                                                                                                                                                                                           |
...
- Примеры: `header`, `intro`, `runline`, `actions`, `callback`, `combomap`, `footer`.
